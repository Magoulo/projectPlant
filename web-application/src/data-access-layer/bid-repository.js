...
module.exports = function () {
	return {
		...
		getAllBidsByUserID: function (userID, callback) {
			...
			const query = "SELECT Bid.bidID, Bid.userID, Bid.adID, Bid.message, Bid.datePosted, Bid.imagePath, Bid.status, Ad.title, Ad.latinName, ImageBundle.coverImagePath FROM Bid JOIN Ad ON Bid.adID = Ad.adID JOIN ImageBundle ON Ad.adID = ImageBundle.adID WHERE Bid.userID = ? ORDER BY Bid.bidID DESC"
			const values = [userID]
